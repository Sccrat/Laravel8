...
class ScheduleTransformDetail extends Model
{
  protected $table = 'wms_schedule_transform_detail';

  protected $fillable = ['transform_id','product_id','position_id','code128_id','code14_id','quanty','detail_type','detail_status','reason_code_id'];
  ...
  {
    return $this->belongsTo('App\Models\ReasonCode');
  }
